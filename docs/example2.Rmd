...
- Non-binding futility bounds are 0 and 0.5 for the first and second interim on normal approximated z-value. In `TrialSimulator`, we calculate the z-value of $\log$ odds ratio. 
